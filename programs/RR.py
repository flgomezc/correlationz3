...
Random = np.loadtxt('../data/RandomFieldCatalog.csv',
                            delimiter=',', usecols=[0,1,2])
...
def Counting_RR():
    ...
    file = open('../results/RR.dat', 'w')  #a append, w write, r read, r+ read+write
    file.write('#'+str(timeit.time.ctime())+'\n')
...
def Counting_DR():
    ...
    file = open('../results/DR.dat', 'w')  #a append, w write, r read, r+ read+write
    file.write('#'+str(timeit.time.ctime())+'\n')
