...
Random = np.loadtxt('../data/RandomFieldCatalog02.csv',
                            delimiter=',', usecols=[0,1,2])
...
def Counting_RR():
    ...
    file = open('../results/RR02.dat', 'w')  #a append, w write, r read, r+ read+write
    file.write('#'+str(timeit.time.ctime())+'\n')
...
def Counting_DR():
    ...
    file = open('../results/DR02.dat', 'w')  #a append, w write, r read, r+ read+write
    file.write('#'+str(timeit.time.ctime())+'\n')
